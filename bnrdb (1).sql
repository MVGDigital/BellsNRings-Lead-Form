...
--
-- Table structure for table `bnr_admin_session`
--

CREATE TABLE `bnr_admin_session` (
...
--
-- Table structure for table `bnr_admin_user`
--

CREATE TABLE `bnr_admin_user` (
  `admin_id` int(11) NOT NULL,
...
--
-- Dumping data for table `bnr_admin_user`
--

INSERT INTO `bnr_admin_user` (`admin_id`, `username`, `password`, `created_date`, `updated_date`) VALUES
(1, 'AdminUser', 'Admin12@', '2024-05-24 04:28:38', '2024-05-31 06:27:15');

-- --------------------------------------------------------

--
-- Table structure for table `bnr_generated_qrcode`
--

CREATE TABLE `bnr_generated_qrcode` (
...
--
-- Table structure for table `bnr_user`
--

CREATE TABLE `bnr_user` (
  `id` int(11) NOT NULL,
  `bnr_id` varchar(100) NOT NULL,
  `qr_id` int(11) DEFAULT NULL,
  `profile_created_for` varchar(18) DEFAULT NULL,
  ...
  `phone_verification_status` tinyint(1) DEFAULT NULL,
  `whatsapp_verification_status` tinyint(1) DEFAULT NULL,
  `registration_status` varchar(18) DEFAULT NULL,
  `created_date` timestamp NOT NULL DEFAULT current_timestamp(),
...
--
-- Dumping data for table `bnr_user`
--

INSERT INTO `bnr_user` (`id`, `bnr_id`, `qr_id`, `profile_created_for`, `first_name`, `last_name`, `gender`, `date_of_birth`, `country`, `state`, `email_id`, `contact_number`, `whatsapp_number`, `email_verification_status`, `phone_verification_status`, `whatsapp_verification_status`, `registration_status`, `created_date`, `last_modified_date`, `created_by`, `last_modified_by`) VALUES
(1, 'BNR1', 0, 'myself', 'Pavi', 'Rajaraman', '', '2006-05-31', '4', '164', 'vel0011@gmail.com', '+919551591506', '+919551591506', 1, 1, 1, 'Verified', '2024-06-09 17:20:24', '2024-06-10 03:44:10', NULL, NULL),
(49, 'BNR4', 0, '', '', '', '', '0000-00-00', '1', '', '', '8909567890', '9856456367', NULL, NULL, NULL, 'Drop', '2024-06-09 18:45:58', '2024-06-09 18:45:58', NULL, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `bnr_user_profile`
--

CREATE TABLE `bnr_user_profile` (
  `profile_id` int(11) NOT NULL,
  `bnr_id` varchar(100) NOT NULL,
  `marital_status` varchar(125) DEFAULT NULL,
  `mother_tongue` varchar(16) DEFAULT NULL,
  `caste` varchar(105) DEFAULT NULL,
  `denomination` varchar(60) DEFAULT NULL,
  `height` varchar(34) DEFAULT NULL,
  `weight` varchar(25) DEFAULT NULL,
  `complexion` varchar(20) DEFAULT NULL,
  `last_education_level` varchar(20) DEFAULT NULL,
  `occupation` varchar(25) DEFAULT NULL,
  `company_name` varchar(20) DEFAULT NULL,
  `annual_income` varchar(102) DEFAULT NULL,
  ...
  `number_of_brothers` varchar(10) DEFAULT NULL,
  `brother_married` varchar(10) DEFAULT NULL,
  `number_of_sisters` varchar(10) DEFAULT NULL,
  `sister_married` varchar(10) DEFAULT NULL,
  `current_address` varchar(255) DEFAULT NULL,
  `permanent_address` varchar(255) DEFAULT NULL,
  `citizen_of` varchar(12) DEFAULT NULL,
...
--
-- Table structure for table `bnr_user_tracking`
--

CREATE TABLE `bnr_user_tracking` (
...
INSERT INTO `master_countries` (`country_id`, `sortname`, `country_name`, `phonecode`) VALUES
(1, 'AF', 'Afghanistan', 93),
(2, 'AL', 'Albania', 355),
(3, 'DZ', 'Algeria', 213),
...
INSERT INTO `master_states` (`state_id`, `state_name`, `country_id`) VALUES
...
--
-- Indexes for table `bnr_admin_session`
--
ALTER TABLE `bnr_admin_session`
  ADD PRIMARY KEY (`session_id`);

--
-- Indexes for table `bnr_admin_user`
--
ALTER TABLE `bnr_admin_user`
  ADD PRIMARY KEY (`admin_id`);

--
-- Indexes for table `bnr_generated_qrcode`
--
ALTER TABLE `bnr_generated_qrcode`
  ADD PRIMARY KEY (`qr_id`);

--
-- Indexes for table `bnr_user`
--
ALTER TABLE `bnr_user`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `bnr_id` (`bnr_id`);

--
-- Indexes for table `bnr_user_profile`
--
ALTER TABLE `bnr_user_profile`
  ADD PRIMARY KEY (`profile_id`);

--
-- Indexes for table `bnr_user_tracking`
--
ALTER TABLE `bnr_user_tracking`
...
--
-- AUTO_INCREMENT for table `bnr_admin_session`
--
ALTER TABLE `bnr_admin_session`
  MODIFY `session_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `bnr_admin_user`
--
ALTER TABLE `bnr_admin_user`
  MODIFY `admin_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `bnr_generated_qrcode`
--
ALTER TABLE `bnr_generated_qrcode`
  MODIFY `qr_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=53;

--
-- AUTO_INCREMENT for table `bnr_user`
--
ALTER TABLE `bnr_user`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=52;

--
-- AUTO_INCREMENT for table `bnr_user_profile`
--
ALTER TABLE `bnr_user_profile`
  MODIFY `profile_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;

--
-- AUTO_INCREMENT for table `bnr_user_tracking`
--
ALTER TABLE `bnr_user_tracking`
