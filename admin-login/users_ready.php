<?php 
	...
	$registration_status = isset($_GET['registration_status']) ? $_GET['registration_status'] : 'Ready';
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    ...
    button.addEventListener('click', () => {
        ...
        var table; // Declare table variable in global scope
            ...
            $.ajax({
                url: 'fetch_data_ready.php', // Path to your PHP script
                ...
                success: function(data) {
                    ...
                    render: function(data, type, row) {
                        // Render the bnr_id as a clickable link to user_view_partial.php
                        return '<a href="user_view_partial.php?bnr_id=' + data + '">' + data + '</a>';
                    }
                },
