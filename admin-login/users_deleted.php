<?php 
	...
	$registration_status = isset($_GET['registration_status']) ? $_GET['registration_status'] : 'Delete';
?>
<!DOCTYPE html>
<html lang="en">
<head>
                ...
                <div class="dash_content">
                  <h1>Deleted Users</h1>
                    ...
                    <div class="tab-container mt_30">
                        ...
                        <button onclick="deleted()" class="tab-button <?php if($registration_status == 'Delete') { ?>active<?php } ?>">Delete</button>
                    </div>
